#[cfg(test)]
mod tests {
    use crate::core::mcp::ToolDefinition;
    use crate::core::mcp::clients::{MCPClient, MCPConnection, StdioMCPClient, WebSocketMCPClient};
    use crate::core::mcp::protocol::{
        CallToolResult, ListToolsResult, MCPRequest, MCPResponse, ResponseResult, ToolContent,
    };
    use crate::core::mcp::transport::{MCPTransport, TransportError};
    ...
    async fn test_mcp_connection_with_mock_transport() {
        use crate::core::mcp::protocol::{InitializeResult, ServerCapabilities, ServerInfo};
