...
use crate::core::mcp::transport::{TransportType, HttpPoolConfig};
...
impl SlackClientNode {
    ...
    pub fn with_http_transport(base_url: String, bot_token: Option<String>, user_token: Option<String>) -> Self {
    ...
    pub fn with_websocket_transport(url: String, bot_token: Option<String>, user_token: Option<String>) -> Self {
        let config = SlackClientConfig {
    ...
    pub fn with_stdio_transport(command: String, args: Vec<String>, bot_token: Option<String>, user_token: Option<String>) -> Self {
        let config = SlackClientConfig {
    ...
    pub async fn send_message(
        ...
        args.insert("channel".to_string(), serde_json::Value::String(channel.to_string()));
        args.insert("text".to_string(), serde_json::Value::String(text.to_string()));
        
        if let Some(thread_ts) = thread_ts {
            args.insert("thread_ts".to_string(), serde_json::Value::String(thread_ts.to_string()));
        }
    ...
    pub async fn list_channels(
        ...
        if let Some(exclude_archived) = exclude_archived {
            args.insert("exclude_archived".to_string(), serde_json::Value::Bool(exclude_archived));
        }
        
        if let Some(types) = types {
            args.insert("types".to_string(), serde_json::Value::Array(
                types.into_iter().map(|t| serde_json::Value::String(t)).collect()
            ));
        }
    ...
    pub async fn get_user_info(&mut self, user_id: &str) -> Result<CallToolResult, WorkflowError> {
        let mut args = HashMap::new();
        args.insert("user".to_string(), serde_json::Value::String(user_id.to_string()));
        
        self.execute_tool("get_user_info", Some(args)).await
    }

    /// Get information about a channel
    pub async fn get_channel_info(&mut self, channel_id: &str) -> Result<CallToolResult, WorkflowError> {
        let mut args = HashMap::new();
        args.insert("channel".to_string(), serde_json::Value::String(channel_id.to_string()));
    ...
    pub async fn get_channel_history(
        ...
        if let Some(oldest) = oldest {
            args.insert("oldest".to_string(), serde_json::Value::String(oldest.to_string()));
        }
        
        if let Some(latest) = latest {
            args.insert("latest".to_string(), serde_json::Value::String(latest.to_string()));
        }
    ...
    pub async fn add_reaction(
        ...
        let mut args = HashMap::new();
        args.insert("channel".to_string(), serde_json::Value::String(channel.to_string()));
        args.insert("timestamp".to_string(), serde_json::Value::String(timestamp.to_string()));
    ...
    pub async fn search_messages(
        ...
        if let Some(sort) = sort {
            args.insert("sort".to_string(), serde_json::Value::String(sort.to_string()));
        }
        
        if let Some(sort_dir) = sort_dir {
            args.insert("sort_dir".to_string(), serde_json::Value::String(sort_dir.to_string()));
        }
    ...
    pub async fn create_channel(
        ...
        if let Some(is_private) = is_private {
            args.insert("is_private".to_string(), serde_json::Value::Bool(is_private));
        }
    ...
    pub async fn invite_to_channel(
        ...
        let mut args = HashMap::new();
        args.insert("channel".to_string(), serde_json::Value::String(channel.to_string()));
        args.insert("users".to_string(), serde_json::Value::Array(
            users.into_iter().map(|u| serde_json::Value::String(u)).collect()
        ));
...
impl Node for SlackClientNode {
    fn process(&self, mut task_context: TaskContext) -> Result<TaskContext, WorkflowError> {
        task_context.set_data("slack_client_processed", true)?;
        task_context.set_data("service_name", "slack")?;
