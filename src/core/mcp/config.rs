...
use crate::core::mcp::connection_pool::ConnectionConfig;
...
impl MCPConfig {
    ...
    fn get_connection_pool_from_env() -> ConnectionConfig {
        ConnectionConfig {
            ...
            load_balancing_strategy: crate::core::mcp::connection_pool::LoadBalancingStrategy::HealthBased,
            circuit_breaker: crate::core::error::circuit_breaker::CircuitBreakerConfig::default(),
            health_monitoring: crate::core::mcp::health::HealthConfig::default(),
            enable_auto_reconnect: Self::get_env_var_or_default("MCP_ENABLE_AUTO_RECONNECT", "true", true),
            backoff_config: crate::core::mcp::connection_pool::BackoffConfig::default(),
        }
    }
