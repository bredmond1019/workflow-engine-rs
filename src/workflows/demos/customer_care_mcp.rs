...
async fn test_list_tools(mcp_server: &CustomerSupportMCPServer) {
    ...
    list_logger.execute_with_logging(
        ...
        || async {
            let list_request = crate::core::mcp::protocol::MCPRequest::ListTools {
                ...
                Ok(response) => {
                    ...
                    match response {
                        crate::core::mcp::protocol::MCPResponse::Result {
                            result:
                                crate::core::mcp::protocol::ResponseResult::ListTools(
                                    tools_result,
                                ),
                            ..
                        } => {
...
async fn test_tool_call(mcp_server: &CustomerSupportMCPServer) {
    ...
    tool_logger.execute_with_logging(
        ...
        || async {
            let call_request = crate::core::mcp::protocol::MCPRequest::CallTool {
                id: "demo-call-001".to_string(),
                params: crate::core::mcp::protocol::ToolCallParams {
                    name: "validate_ticket".to_string(),
                    arguments: Some({
            ...
            match mcp_server.get_server().handle_request(call_request).await {
                Ok(response) => {
                    ...
                    match response {
                        crate::core::mcp::protocol::MCPResponse::Result {
                            result:
                                crate::core::mcp::protocol::ResponseResult::CallTool(
                                    call_result,
                                ),
                            ..
                        } => {
